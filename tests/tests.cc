...
TEST_CASE("CheckBalance", "[check-balance]"){
 Atm atm;
 atm.RegisterAccount(12345678, 1234, "Sam Sepiol", 300.30);
 auto accounts = atm.GetAccounts();
 REQUIRE(accounts.contains({1234, 12345678}) == false);
  REQUIRE_THROWS_AS(atm.RegisterAccount(12345678, 1234, "Sam Sepiol", 300.30), std::runtime_error);
